...
import org.quattor.pan.dml.functions.Push;
...
import org.quattor.pan.dml.functions.Substitute;
...
public class PanParserAstUtils {
    ...
    static {
        try {
            ...
            fc.put("push", (Push.class).getDeclaredMethod("getInstance", SourceRange.class, Operation[].class));
